...
iframe {
  ...
  `;
    ...
    return (
        <LeftWrapper>
            {data.video &&
                <iframe width="400" height="200" src={`https://www.youtube.com/embed/${data.video.key}?autoplay=1&mute=1`} title={`${data.title} 예고편`} frameBorder="0" allowFullScreen></iframe>
            }
